      ...
      <div className="border border-zinc-800 bg-zinc-900/30 p-8">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-600">connecting to predict.fun cache</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="text-green-500">$</span>
            <span className="text-zinc-100">scan --market predict.fun --mode {activeTab}</span>
          </div>
          <p className="text-xs text-zinc-600">// blast chain • hybrid CLOB</p>
        </div>
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-zinc-800 bg-zinc-900/50">
              ...
              <th className="px-3 py-2 text-right font-medium text-zinc-500">ME</th>
              <th className="px-3 py-2 text-right font-medium text-zinc-500">LIQ</th>
            </tr>
          </thead>
          <tbody>
